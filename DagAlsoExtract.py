...
# Import the function from your separate script
# The `scripts` folder must be in the same directory as the DAG file
# and must contain an __init__.py file.
...
# Local file path defined in your script
